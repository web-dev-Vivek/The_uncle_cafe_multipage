    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative text-center text-white max-w-4xl mx-auto px-4 z-10">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight playful-font">
            Taste the <span className="text-yellow-400">Perfect</span> Burger
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-200 font-bold">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/menu"
              onClick={scrollToTop}
              className="group inline-flex items-center px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl playful-font"
            >
              View Our Menu
            ...
            <Link
              to="/contact"
              onClick={scrollToTop}
              className="inline-flex items-center px-8 py-4 bg-yellow-400 text-black hover:bg-yellow-500 font-bold rounded-lg transition-all duration-300 shadow-lg playful-font"
            >
              Visit Us Today
            </Link>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-black mb-4 playful-font">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="text-center group bg-yellow-50 p-8 rounded-lg hover:shadow-lg transition-all duration-300 border-2 border-yellow-200">
                <div className="mb-6 flex justify-center">
                  <div className="p-4 bg-white rounded-full shadow-md group-hover:shadow-lg transition-all duration-300 border-2 border-orange-200">
                    {feature.icon}
                  </div>
                </div>
                <h3 className="text-2xl font-bold text-black mb-4 playful-font">
                  {feature.title}
                </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 border-yellow-200">
              <div className="h-48 bg-cover bg-center group-hover:scale-105 transition-transform duration-300" style={{
          ...
          <div className="text-center mt-12">
            <Link
              to="/menu"
              onClick={scrollToTop}
              className="group inline-flex items-center px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-lg transition-all duration-300 shadow-lg playful-font"
            >
              View Full Menu
              <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </Link>
