            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-yellow-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all font-semibold text-sm sm:text-base"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-yellow-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all resize-none font-semibold text-sm sm:text-base"
                  ...
                  <div key={index} className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      {info.details.map((detail, detailIndex) => (
                        <p key={detailIndex} className="text-gray-700 font-semibold text-sm sm:text-base">
                          {detail}
                        </p>
                      ))}
                    </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 border-2 border-yellow-200">
              ...
              <div className="h-48 sm:h-56 lg:h-64 bg-yellow-100 rounded-lg flex items-center justify-center border-2 border-orange-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-700 font-bold text-sm sm:text-base">Interactive Map</p>
