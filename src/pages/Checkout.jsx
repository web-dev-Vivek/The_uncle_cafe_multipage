      ...
      <div className="min-h-screen py-12 sm:py-16 lg:py-20 pt-20 sm:pt-24 lg:pt-32 bg-yellow-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-lg shadow-lg p-8 sm:p-12 border-4 border-yellow-300">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-black mb-4 playful-font">Order Placed Successfully!</h1>
            ...
            <div className="space-y-4">
              <p className="text-orange-600 font-bold text-base sm:text-lg">Estimated delivery time: 25-35 minutes</p>
              <Link
                to="/menu"
                onClick={scrollToTop}
      ...
      <div className="min-h-screen py-12 sm:py-16 lg:py-20 pt-20 sm:pt-24 lg:pt-32 bg-yellow-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-lg shadow-lg p-8 sm:p-12 border-4 border-yellow-300">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-black mb-4 playful-font">Your Cart is Empty</h1>
            <p className="text-gray-700 mb-6 sm:mb-8 font-bold text-sm sm:text-base">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 border-2 border-yellow-200">
              <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 sm:mb-6 playful-font">Your Order</h2>
              <div className="space-y-3 sm:space-y-4">
                {cart.map((item) => (
                  <div key={item.id} className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-yellow-50 rounded-lg border-2 border-orange-200">
                    <div 
                      className="w-12 h-12 sm:w-16 sm:h-16 bg-cover bg-center rounded-lg border-2 border-yellow-300 flex-shrink-0"
                      style={{ backgroundImage: `url(${item.image})` }}
                    ></div>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-black font-bold playful-font text-sm sm:text-base truncate">{item.name}</h3>
                      <p className="text-gray-700 text-xs sm:text-sm font-semibold truncate">{item.description}</p>
                      <p className="text-orange-600 font-bold text-sm sm:text-base">${item.price.toFixed(2)}</p>
                    </div>
                    <div className="flex items-center space-x-1 sm:space-x-2">
                      ...
                      <span className="text-black font-bold w-6 sm:w-8 text-center text-sm sm:text-base">{item.quantity}</span>
                      <button
                        onClick={() => updateCartQuantity(item.id, item.quantity + 1)}
                        className="p-1 rounded-full bg-yellow-200 hover:bg-yellow-300 text-black transition-all duration-300 border-2 border-orange-300"
                      >
          ...
          <div className="space-y-4 sm:space-y-6">
            {/* Order Summary */}
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 border-2 border-yellow-200">
              <h2 className="text-lg sm:text-xl font-bold text-black mb-3 sm:mb-4 playful-font">Order Summary</h2>
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 border-2 border-yellow-200">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 p-3 bg-yellow-50 rounded-lg border-2 border-orange-200">
                  ...
                  <span className="text-black font-semibold text-sm sm:text-base">Credit Card ending in 4242</span>
                </div>
